...
public class Databaseconnection {
	...
	public static Connection getConnection() {
		try {
			...
			connection = DriverManager.getConnection("jdbc:mysql://localhost:3308/online", "root", "Pavan@123");
		} catch (Exception e) {
			e.printStackTrace();
		}
		return (connection);
	...
	// Creating universal method to query for inserting or updating information in
	// mysql database
